...
{
    home.file.".ICACLIENT/All_Regions.ini".text = ''
...
ToolbarVersion=*
ToolbarButtonClose=*
ToolbarButtonDevices=*
ToolbarButtonFullscreen=*
ToolbarButtonMinimize=*
ToolbarButtonPin=*
ToolbarButtonPreferences=*
ToolbarButtonShortcuts=*
ToolbarButtonSwitchDesktop=*
...
DesktopSessionResizeEventTimeout=*
;
